...
public class Table extends javax.swing.JPanel {
    ...
    public Object LayMaQuyenTaiTable(int row){
        ...
        public Object LayTenQuyenTaiTable(int row){
        for(int i = 0; i < jTable1.getColumnCount(); ++i){
            if(jTable1.getColumnName(i).equals("Tên quyền")){
                return jTable1.getValueAt(row, i);
            }
        }
        return null;
...
private void initComponents() {
    ...
    // Đảm bảo layout của panel sử dụng BorderLayout
    this.setLayout(new BorderLayout());
    // Đưa JTable vào vị trí CENTER của BorderLayout
    this.add(jScrollPane1, BorderLayout.CENTER);
}   
/*-----------------------------------------------------------------------------------------------------------------------*/
    // Xử lý sự kiện khi có thay đổi trong bảng, đảm bảo việc cập nhật dữ liệu được thực hiện đồng bộ. 
