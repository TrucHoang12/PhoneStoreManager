    ...
    private void btnThemSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemSuaActionPerformed
        ...
        if (type.equals("Sửa")) {
            ...
            if (xltkBUS.repairTaiKhoan(TenTaiKhoan, MatKhau, MaNV, MaQuyen)) {
                XulyTaiKhoanPanel.tb.setValueRow(TenTaiKhoan, new String[]{Integer.toString(row), TenTaiKhoan, MatKhau, MaNV, MaQuyen});
            ...
            if (xltkBUS.addTaiKhoan(tk)) {
                XulyTaiKhoanPanel.tb.addRow(new String[]{
                    Integer.toString(XulyTaiKhoanPanel.tb.getRowCount() + 1), TenTaiKhoan, MatKhau, MaNV, MaQuyen
                });
