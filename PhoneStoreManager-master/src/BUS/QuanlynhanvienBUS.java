...
public class QuanlynhanvienBUS {
    public  String[] getComboboxSearch = {"Tất cả", "Mã nhân viên", "Tên nhân viên", "Ngày sinh", "Địa chỉ", "Số điện thoại", "Trạng thái"};
    public  String[] getHeaders = {"STT", "Mã nhân viên", "Tên nhân viên", "Ngày sinh", "Địa chỉ", "Số điện thoại", "Trạng thái"};
    private  ArrayList<NhanVien> a;
    ...
    public  ArrayList<NhanVien> SearchNhanVien(String s, String type){
    ...
    public  ArrayList<NhanVien> SearchNVAge(int ag1, int ag2){
...
//            System.out.println(year - Integer.parseInt(s[0]));
    ...
    public  ArrayList<NhanVien> SearchNVFromDate(int yearfrom, int monthfrom, int dayfrom, int yearto, int monthto, int dayto){
