...
import DAO.QuanlykhuyenmaiDAO;
import java.time.LocalDate;
import java.util.ArrayList;

public class QuanlykhuyenmaiBUS {
    public  String[] getComboboxSearch = {"Tất cả", "Mã KM", "Tên KM", "Điều kiện KM", "Phần trăm KM", "Ngày bắt đầu", "Ngày kết thúc", "Trạng thái"};
    public  String[] getHeaders = {"STT", "Mã KM", "Tên KM", "Điều kiện KM", "Phần trăm KM", "Ngày bắt đầu", "Ngày kết thúc", "Trạng thái"};
    private  ArrayList<KhuyenMai> a;
    ...
    public  ArrayList<KhuyenMai> SearchKhuyenMai(String s, String type){
    ...
    public  boolean CompareDate(String y11, String m11, String d11, String y22, String m22, String d22){
    ...
    public  String ToCurrent(String s){
