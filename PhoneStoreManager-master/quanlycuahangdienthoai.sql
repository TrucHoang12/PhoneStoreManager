...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th9 21, 2023 lúc 05:45 PM
...
('HD1', 'NV2', 'KH2', 'KM2', '2023-09-21', '22:45:52', 267000000),
('HD10', 'NV23', 'KH16', 'KM1', '2023-09-24', '22:16:58', 329900000),
('HD11', 'NV12', 'KH22', 'KM1', '2023-09-25', '13:20:37', 75700000),
('HD12', 'NV12', 'KH19', 'KM3', '2023-09-25', '17:59:11', 84000000),
('HD13', 'NV12', 'KH14', 'KM1', '2023-09-25', '18:58:06', 101200000),
('HD14', 'NV12', 'KH19', 'KM3', '2023-09-26', '14:14:27', 975100032),
('HD15', 'NV12', 'KH15', 'KM5', '2023-09-26', '15:12:27', 100900000),
('HD16', 'NV12', 'KH1', 'KM4', '2023-09-26', '11:21:12', 400000000),
('HD2', 'NV1', 'KH1', 'KM1', '2023-09-22', '23:15:36', 240000000),
('HD3', 'NV1', 'KH1', 'KM1', '2023-09-22', '18:44:34', 35000000),
('HD4', 'NV1', 'KH1', 'KM1', '2023-09-22', '12:13:48', 60000000),
('HD5', 'NV15', 'KH1', 'KM1', '2023-09-22', '03:18:01', 31600000),
('HD6', 'NV15', 'KH7', 'KM1', '2023-09-22', '03:21:35', 174600000),
('HD7', 'NV15', 'KH13', 'KM1', '2023-09-22', '03:22:30', 81000000),
('HD8', 'NV15', 'KH3', 'KM1', '2023-09-22', '11:29:50', 17400000),
('HD9', 'NV15', 'KH12', 'KM1', '2023-09-22', '21:43:30', 43900000);
...
('KH11', 'Nguyễn Xuân Diệu', 'TP HCM', '0301279552', 1),
...
('KM1', 'Không khuyến mãi', 0, 0, '2023-09-19', '2024-04-30'),
('KM2', 'Giảm giá nhân ngày 30/4', 5000000, 30, '2023-11-20', '2023-12-20'),
('KM3', 'Giảm giá 1/5', 2000000, 10, '2023-09-17', '2023-09-20'),
('KM4', 'Giảm giá tết', 15000000, 20, '2023-09-19', '2023-09-20'),
('KM5', 'Khuyến mãi xả hàng', 1000000, 50, '2023-09-18', '2023-09-25'),
('KM6', 'Khuyến mãi mùa hè', 15000000, 20, '2023-09-18', '2023-09-27'),
('KM7', 'Khuyến mãi mùa hè 2', 5000000, 5, '2023-09-22', '2023-10-24');
...
('NCC1', 'Cty Samsung', 'TP HCM', '0904578966', '4598-8789-8789-7897'),
...
('NV10', 'Nguyễn Tuyến Đạt', '2000-02-19', 'HCM', '0126236819', 0),
...
('NV28', 'Mạc Văn Khoa', '1991-12-03', 'Dak Lak', '0364117408', 1),
('NV3', 'Nguyễn Bá Được', '1998-04-05', 'Hà Nội', '0128456786', 1),
('NV4', 'Trần Văn Hoàng', '1999-11-12', 'TP HCM', '0120776466', 1),
...
('Q1', 'Quản lý', 'qlSanPham qlLoaiSanPham qlHoaDon qlKhuyenMai qlNhanVien qlKhachHang xemPhieuNhap qlNCC'),
('Q2', 'Nhân viên Bán hàng', 'qlBanHang xemSanPham xemLoaiSanPham qlHoaDon xemKhuyenMai qlKhachHang'),
('Q3', 'Admin', 'qlTaiKhoan qlQuyen'),
('Q4', 'Nhân viên Nhập hàng', 'qlNhapHang xemSanPham qlPhieuNhap xemNCC');
...
('PN1', 'NCC2', 'NV1', '2023-09-21', '01:25:08', 296000000),
('PN2', 'NCC3', 'NV1', '2023-09-21', '01:25:23', 276500000),
('PN3', 'NCC5', 'NV12', '2023-09-22', '17:06:52', 100000000),
('PN4', 'NCC4', 'NV12', '2023-09-22', '02:51:18', 48800000),
('PN5', 'NCC5', 'NV12', '2023-09-22', '17:54:01', 46900000),
('PN6', 'NCC8', 'NV12', '2023-09-23', '17:58:26', 106900000),
('PN7', 'NCC6', 'NV12', '2023-09-24', '14:15:27', 1190000000),
('PN8', 'NCC1', 'NV12', '2023-09-24', '11:19:10', 119000000),
('PN9', 'NCC2', 'NV12', '2023-09-25', '11:19:53', 200000000);
...
('SP6', 'LSP5', 'Nokia 6.1 Plus', 6500000, 44, 'nokia-61-plus-3-400x460.jpg', 0),
...
('SP9', 'LSP3', 'Samsung Galaxy S10+ (512GB)', 29000000, 60, 'samsung-galaxy-s10-plus-512gb-ceramic-black-400x460.jpg', 1);
...
-- Thêm ràng buộc CHECK vào bảng khachhang
ALTER TABLE khachhang
ADD CONSTRAINT chk_SDT_KH_Length CHECK (LENGTH(SDT) = 10);

-- Thêm ràng buộc CHECK vào bảng nhanvien
ALTER TABLE nhanvien
ADD CONSTRAINT chk_SDT_NV_Length CHECK (LENGTH(SDT) = 10);
